...
class ResidualVQ(nn.Module):
    ...
    def forward(self, z, n_quantizers: int = None):
        ...
        all_commit_losses = 0.0
        all_codebook_losses = 0.0
        all_indices = []
        all_quantized = []
        ...
        for i, quantizer in enumerate(self.quantizers):
            if self.training is False and i >= n_quantizers:
                break
            # I don't see zei used ANYWHERE
            #z_q_i, commit_loss_i, codebook_loss_i, indices_i, z_e_i = quantizer(residual)
            z_q_i, commit_loss_i, codebook_loss_i, indices_i = quantizer(residual)
            ...
            # **Detach z_q_i before updating residual**
            ...
            # Assuming all inputs are going to be of uniform size. So how this works is
            # you take ALLL YOUR AUDIO FILES, mkay? Put em end to end in this BIG ASS LONG FILE in memory.
            # Then chop it up into neat sized chunks. As the function of this thing is supposed to be like a VAE
            # context information shouldn't matter, and if context information shouldn't matter, then this should be ok
            # Alright let's do this thing! If it fails hard and we really need hundreds of GB of VRAM just to trainn this
            # stupid module, then GG. But I don't buy it. 
           
            # weird proposed hack for being more memory efficient. Will it work? who knows.
            # There ain't no goddamn way this thing keeps eating up VRAM every iteration. Nah man that's bullshit.
            # Somethin weird goin on in here. 
        ...
        #    all_codebook_losses.append(codebook_loss_i)
            ...
            all_quantized.append(z_q_i.detach())
#
