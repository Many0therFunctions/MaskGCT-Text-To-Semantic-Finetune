...
from maskgct.g2p.g2p import cleaners
from tokenizers import Tokenizer
from maskgct.g2p.g2p.text_tokenizers import TextTokenizer
import LangSegment
import json
import re
...
class PhonemeBpeTokenizer:
    ...
    def __init__(self, vacab_path="./vocab.json"):
        self.lang2backend = {
            "zh": "cmn",
            "zh-debug": "cmn",
            "cantonese": "yue",
        ...
        LangSegment.setfilters(["en", "zh", "ja", "ko", "fr", "de", "vi"])
