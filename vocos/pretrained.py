...
class Vocos(nn.Module):
    ...
    @classmethod
    def from_pretrained(self, repo_id: str, device="cuda") -> "Vocos":
        """
        ...
        safetensors_path = f"{repo_id}/model.safetensors"
        if os.path.isfile(safetensors_path):
            model_path = safetensors_path
        else:
            model_path = f"{repo_id}/pytorch_model.bin" #hf_hub_download(repo_id=repo_id, filename="pytorch_model.bin")
